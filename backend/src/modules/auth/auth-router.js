...
const { LoginSchema, PasswordChangeSchema, SetupPasswordSchema } = require("./auth-schema");
...
router.post("/reset-pwd", authenticateToken, csrfProtection, checkApiAccess, validateRequest(PasswordChangeSchema), authController.handlePwdReset);
